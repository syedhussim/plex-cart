...
<div class="dy-fx fx-fx-maxc wh-100-pc">
    <div class="pt-20 app-bar">
        ...
        <a href="" class="app-bar-item ${equals(request.url().segments(0),'catalog','app-bar-item-selected')}">
    ...
    <div class="app-menu">
        ...
        <ul class="pg-0 mn-0" style="list-style:none;">
            <li class="menu-item ${equals(request.url().segments(1),'products','menu-item-selected')}">
                <a href="/catalog/products">Products</a>
                <a href="/catalog/products/create" class="c">+</a>
            </li>
            <li class="menu-item ${equals(request.url().segments(1),'attributes','menu-item-selected')}">
                <a href="">Atributes</a>
                <a href="/catalog/attributes/create" class="c">+</a>
            </li>
            <li class="menu-item">
    ...
    <div class="dy-fx fx-fd-cn fx-fx-maxc">