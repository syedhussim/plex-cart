    ...
    <body id="app">
        ...
        <div class="dy-fx fx-fx-maxc wh-100-pc">
            <div class="pt-20 app-bar">
                <a href="/sales/orders" class="app-bar-item {{ request.url().segments(1) == 'sales' ? 'app-bar-item-selected' : '' }}">
                ...
                <a href="/catalog/products" class="app-bar-item {{ request.url().segments(0) == 'catalog' ? 'app-bar-item-selected' : '' }}">
                ...
                <a a href="/store/settings" class="app-bar-item {{ request.url().segments(0) == 'store' ? 'app-bar-item-selected' : '' }}">
