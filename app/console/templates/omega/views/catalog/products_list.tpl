<div class="dy-fx fx-fd-rw minw-600-px maxw-600-px br-cr-1-1px fx-fx-maxc">
    <div class="dy-fx fx-fd-cn wh-100-pc pt-25 pb-25">
        ...
        <div class="dy-fx">
            ...
            @{foreach product in products} 
                <tr class="bb-cr-1-1px" style="${equals(selectedProduct.id, product.id, 'border-left:3px solid red')}" >
                    <td class="wh-80-px bb-cr-1-1px">
                        <div style="padding:10px; text-align:center;">
                            <svg version="1.1" viewBox="0 0 512.001 512.001" width="40" fill="#888888">
                    ...
                    <td class="pg-10">
                        <a href="/catalog/products?pid=${product.id}">${product.name}</a>
                        <div>${product.sku}</div>
                    </td>
