...
<div class="{{ attributes.empty() ? 'app-container-full' : 'app-container' }} fx-jc-cr fx-ai-cr">
    ...
    <div class="dy-fx fx-fd-cn fx-ai-cr">
        ...
        {% if attributes.empty() %}
            <p class="fs-18 fw-500">Create attributes to add dynamic properties to page content.</p>
            <a href="/content/attributes/create" class="btn-commit maxw-200-px">Create Attribute</a>
        {% else %}
